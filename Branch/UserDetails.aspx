<%@ Page Title="" Language="C#" MasterPageFile="~/Branch/Branch.master" AutoEventWireup="true" CodeFile="UserDetails.aspx.cs" Inherits="Branch_UserDetails" %>
    ...
    <table align="center" class="style1" width="80%">
        ...
        <tr __designer:mapid="1c5">
            <td __designer:mapid="1c6">
                                &nbsp;</td>
            <td __designer:mapid="1c7" colspan="2">
                &nbsp;</td>
        ...
        <tr __designer:mapid="1c5">
            <td __designer:mapid="1c6">
                                <asp:Button ID="Button4" class="btn btn-danger" runat="server" onclick="Button4_Click" Text="Delete" 
...
&nbsp;&nbsp;&nbsp;
        ...
        <tr __designer:mapid="1c9">
            <td __designer:mapid="1ca" colspan="4">
                                &nbsp;</td>
        </tr>
        <tr>
            <td colspan="4">

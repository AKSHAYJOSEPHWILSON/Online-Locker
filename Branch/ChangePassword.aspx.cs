...
public partial class Branch_ChangePassword : System.Web.UI.Page
{
    ...
    {
        string str = "select * from Branch_tb where BranchId='" + Session["Id"].ToString() + "' and Password='" + txtoldpassword.Text + "'";
        DataSet ds = dm.For_Adapter(str);
        if (ds.Tables[0].Rows.Count > 0)
        {
            lblmsg.Text = "";
            string sql = "update Branch_tb set Password='" + txtnewpassword.Text + "' where BranchId='" + Session["Id"].ToString() + "'";

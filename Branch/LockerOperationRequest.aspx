<%@ Page Title="" Language="C#" MasterPageFile="~/Branch/Branch.master" AutoEventWireup="true" CodeFile="LockerOperationRequest.aspx.cs" Inherits="Branch_ViewLockerRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="w3_agile_team_grid">
				<div class="w3_agile_team_grid_left">
					<h3 class="w3l_header w3_agileits_header"><span>Locker Operation Requests</span></h3>
                                ...
                                <table align="center" class="style2">
                                    <tr>
                                        <td style="text-align: center">
                                            &nbsp;</td>
                                        <td colspan="2" style="text-align: center"><strong>Operation Request Details</strong></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            &nbsp;</td>

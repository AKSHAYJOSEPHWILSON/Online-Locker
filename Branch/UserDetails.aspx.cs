...
public partial class Branch_UserDetails : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/Branch/ScheduledLockerOperation.aspx?UserId=" + lbluserId.Text);
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/Branch/LockerOperationHistory.aspx?UserId=" + lbluserId.Text);
    ...
    {
        Response.Redirect("~/Branch/ViewRentDetails.aspx?UserId=" + lbluserId.Text);
    }
    protected void Button6_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/Branch/ViewAdditionalChargeDetails.aspx?UserId=" + lbluserId.Text);
    }
}